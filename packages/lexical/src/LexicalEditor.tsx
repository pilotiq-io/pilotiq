...
import type { BlockMeta } from '@pilotiq/panels'
...
export interface Props {
   ...
   * changes. Used by `@pilotiq/panels` to register the editor in a global
...
// in @pilotiq/panels). Cleanup runs on unmount or when the editor changes.
