...
import type { FieldMeta, SectionMeta, TabsMeta, PanelI18n, RecordRow } from '@pilotiq/panels'
        ...
        {widgetData && widgetData.length > 0 && (
          <div className="flex flex-col gap-4 mb-6">
            {widgetData.map((el, i: number) => (
              <SchemaElementRenderer key={i} element={el as import('@pilotiq/panels').PanelSchemaElementMeta} panelPath={`/${pathSegment}`} i18n={i18n} />
            ))}
          </div>
        )}
