...
export default function ResourceIndex() {
  const ctx = usePageContext() as unknown as { viewProps?: Record<string, unknown> }
  const { basePath, resource, columns } = ctx.viewProps as any ?? {}
  return (
    <>
...
`
  ...
  // ── Custom Page ───────────────────────────────────────────
  writeIfChanged(path.join(outDir, 'page', '+route.ts'), `// AUTO-GENERATED by @pilotiq/pilotiq — do not edit.
import type { RouteSync } from 'vike/types'
import { PilotiqRegistry } from '@pilotiq/pilotiq/registry'
...
`)
  writeIfChanged(path.join(outDir, 'page', '+data.ts'), dataStub)
  writeIfChanged(path.join(outDir, 'page', '+Page.tsx'), `// AUTO-GENERATED by @pilotiq/pilotiq — do not edit.
import { usePageContext } from 'vike-react/usePageContext'
import { SchemaRenderer } from '@pilotiq/pilotiq/react'
