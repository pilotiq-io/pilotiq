...
import { Resource, TextField, EmailField, BooleanField, DateField } from '@pilotiq/panels'
...
```ts
import { Panel, Heading, Text, Stats, Stat, Table } from '@pilotiq/panels'
...
```ts
import { FieldType } from '@pilotiq/panels'
...
```ts
import { Section, TextField, TextareaField, SelectField, FileField } from '@pilotiq/panels'
...
```ts
import { Tabs } from '@pilotiq/panels'
...
```ts
import { Wizard, Step, TextField, EmailField, SelectField, TextareaField } from '@pilotiq/panels'
...
```ts
import { FileField } from '@pilotiq/panels'
...
```ts
import { SelectFilter, SearchFilter } from '@pilotiq/panels'
...
```ts
import { DateFilter, BooleanFilter, NumberFilter, QueryFilter } from '@pilotiq/panels'
...
```ts
import { Action } from '@pilotiq/panels'
...
```ts
import { Action, ActionGroup } from '@pilotiq/panels'
...
```ts
import { Table, Action } from '@pilotiq/panels'
...
```ts
import { Import, TextField, EmailField } from '@pilotiq/panels'
...
```ts
import { Global, TextField, ToggleField, Section } from '@pilotiq/panels'
...
For each resource, `@pilotiq/panels` mounts:
...
```ts
import { RelationManager, TextField, TextareaField, DateField } from '@pilotiq/panels'
...
```ts
// pages/(panels)/@panel/articles/+data.ts
import { resourceData } from '@pilotiq/panels'
