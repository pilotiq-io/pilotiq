...
```ts
import { Form, TextField, EmailField, TextareaField } from '@pilotiq/panels'
...
All field types from `@pilotiq/panels` work in standalone forms.
...
```ts
import { TextField } from '@pilotiq/panels'
...
```ts
import { EmailField } from '@pilotiq/panels'
...
```ts
import { PasswordField } from '@pilotiq/panels'
...
```ts
import { NumberField } from '@pilotiq/panels'
...
```ts
import { TextareaField } from '@pilotiq/panels'
...
```ts
import { SelectField } from '@pilotiq/panels'
...
```ts
import { BooleanField } from '@pilotiq/panels'
...
```ts
import { ToggleField } from '@pilotiq/panels'
...
```ts
import { DateField } from '@pilotiq/panels'
...
```ts
import { ColorField } from '@pilotiq/panels'
...
```ts
import { TagsField } from '@pilotiq/panels'
...
```ts
import { SlugField } from '@pilotiq/panels'
...
```ts
import { JsonField } from '@pilotiq/panels'
...
```ts
import { HiddenField } from '@pilotiq/panels'
...
```ts
import { Form, Section, TextField, EmailField, BooleanField, SelectField } from '@pilotiq/panels'
...
```ts
import { Form, Tabs, TextField, EmailField, TextareaField, ToggleField } from '@pilotiq/panels'
...
```ts
import { Form, TextField, TextareaField, NumberField } from '@pilotiq/panels'
