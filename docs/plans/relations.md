...
| 6. Vike page stubs | ⏳ NOT STARTED | Auto-generated by `vite.ts` plugin: `pages/(pilotiq)/relation-list/`, `relation-create/`, `relation-edit/`. Same dispatch pattern as the existing resource stubs — server resolves, client renders `<SchemaRenderer />`. |
