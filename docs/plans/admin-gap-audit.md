...
| 11 | `relations.md` 📄 DRAFTED | ~2 weeks | RelationManager. Plan doc landed 2026-05-01 — scoped to hasOne/hasMany/belongsTo (rudder ORM coverage); pivot/M2M deferred until ORM adds `belongsToMany`. |
