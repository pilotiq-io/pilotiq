...
// NOTE: free pilotiq playground — no @pilotiq-pro/ai, no @pilotiq-pro/collab.
// Field.persist(['websocket','indexeddb']) and Field.ai([...]) are NOT used
// here; both are pro-only seams. RichContentField runs in local-only mode
// via the useYjsCollab stub from @pilotiq/lexical (isCollab: false).
